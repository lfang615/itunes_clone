<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminCart.aspx.cs" Inherits="MyProject.adminCart" MasterPageFile="~/Admin/AdminMaster.Master" %>

<asp:Content ID="addNew" runat="server" ContentPlaceHolderID="btnPlaceholder">
    <asp:LinkButton ID="btnAddNew" CssClass="addNew" runat="server" OnClick="btnAddNew_Click" Text="Add New Cart"></asp:LinkButton>
</asp:Content>
    ...
    <asp:GridView runat="server" ID="adminGrid" AutoGenerateColumns="false" OnRowEditing="adminGrid_RowEditing" OnRowUpdating="adminGrid_RowUpdating"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Cart Id">
                ...
                <EditItemTemplate>
                    <asp:Label ID="lblCartId" runat="server" Text='<%# Bind ("Id") %>'></asp:Label>
                </EditItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Customer Id">
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="txtCustId" runat="server" Text='<%# Bind ("CustomerId") %>'></asp:TextBox>
                </EditItemTemplate>
            </asp:TemplateField>
